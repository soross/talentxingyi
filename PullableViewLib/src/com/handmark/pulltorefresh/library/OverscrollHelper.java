...
public final class OverscrollHelper {
	 ...
	 *        call
	 * @param scrollX
	 *        - Current X scroll value in pixels before applying deltaY, passed
	 *        through from from overScrollBy call
	 * @param deltaY
	 *        - Change in Y in pixels, passed through from from overScrollBy
	 *        call
	 * @param scrollY
	 *        - Current Y scroll value in pixels before applying deltaY, passed
	 *        through from from overScrollBy call
	 * @param isTouchEvent
	 ...
	 *        other values. Needed for WebView as it doesn't always scroll back
	 *        to it's edge. 0 = no fuzziness.
	 * @param scaleFactor
