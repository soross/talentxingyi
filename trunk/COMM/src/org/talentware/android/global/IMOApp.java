...
public class IMOApp extends Application {
	...
	// public HashMap<Integer, HashMap<Integer, EmployeeInfoItem>>
	// deptUserInfoMap;

	public HashMap<Integer, Integer> userStateMap;

	// public void updateData(int[] deptid, int[] dept_uc, int[] dept_user_uc,
	// HashMap<Integer, DeptMaskItem> deptInfoMap, HashMap<Integer, int[]>
	// deptUserIdsMap, HashMap<Integer, int[]> deptUserNextSiblingMap,
	...
	// public HashMap<Integer, ArrayList<Integer>> innerGroupContactMap = new
	// HashMap<Integer, ArrayList<Integer>>();
	// /** 内部联系人工作签名映射 */
	// public HashMap<Integer, String> innerContactWorkSignMap = new
	// HashMap<Integer, String>();
	// /** 外部联系人Group Map */
	// public HashMap<Integer, OuterContactorItem> outerGroupIdMap;
	//
	// /** 外部联系人Group_Contact_Map */
	// public HashMap<Integer, ArrayList<OuterContactItem>> outerGroupContactMap
	...
	//
	// /** 外部联系人状态信息 */
	// public HashMap<Integer, Integer> outerUserStateMap = new HashMap<Integer,
	// Integer>();
	//
	// /**
	// * 得到内部联系人的 EmployeeInfo Map : 在进入该界面的时候构建
	// */
	// public HashMap<Integer, ArrayList<EmployeeInfoItem>>
	// mInnerGroupContactMap = null;
	//
	// /** 联系人根节点 */
	...
	// */
	// public void updateContactData(HashMap<Integer, InnerContactorItem>
	// innerGroupIdMap, HashMap<Integer, ArrayList<Integer>>
	// innerGroupContactMap, HashMap<Integer, String> innerContactWorkSignMap,
	// HashMap<Integer, OuterContactorItem> outerGroupIdMap,
	// HashMap<Integer, ArrayList<OuterContactItem>> outerGroupContactMap,
	// HashMap<Integer, String> outerContactCorpMap, HashMap<Integer,
	// OuterContactBasicInfo> outerContactInfoMap) {
	...
	public void onCreate() {
		...
		LogFactory.i(IMOApp.class.getSimpleName(), "AppContext onCreate");
		LogFactory.d(IMOApp.class.getSimpleName(), "getApplicationContext:" + (getApplicationContext() == null));
		bindService(new Intent(getApplicationContext(), AppService.class), null, Context.BIND_AUTO_CREATE);

		notificationManager = (NotificationManager) getSystemService(NOTIFICATION_SERVICE);

		// connectionChangeReceiver = new ConnectionChangeReceiver();
		// registerReceiver(connectionChangeReceiver, new
