...
public final class PullToRefreshExpandableListActivity extends ExpandableListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new SimpleExpandableListAdapter(this, groupData, android.R.layout.simple_expandable_list_item_1, new String[] {
			KEY
		}, new int[] {
			android.R.id.text1
		}, childData, android.R.layout.simple_expandable_list_item_2, new String[] {
			KEY
		}, new int[] {
			android.R.id.text1
		});
