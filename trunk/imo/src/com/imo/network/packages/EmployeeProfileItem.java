...
public class EmployeeProfileItem {
	...
	public EmployeeProfileItem(String user_account, String corp_account,
			String name, int gender, String sign, String mobile, String email,
			int role_id, int head_pic, int privacy_flag, int birth, String pos,
			String tel, String desp, String hide_dept_list) {
		...
		for(int i = maskArray.length-1 ; i > 0; i--)
		{
			if ('1' == maskArray[i] )
			{
				...
				case 25:
					...
					email = StringUtils.UNICODE_TO_UTF8(emailBuffer);						break;
				case 26:
