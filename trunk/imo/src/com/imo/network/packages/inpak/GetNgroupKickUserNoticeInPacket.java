...
public class GetNgroupKickUserNoticeInPacket extends CommonInPacket {
	...
	public GetNgroupKickUserNoticeInPacket(ByteBuffer aData, int aBodyLen) {
		super(aData, aBodyLen);
		ngroup_id = body.getInt();
		unCid = body.getInt();
		unUid = body.getInt();
		LogFactory.d("GetNgroupKickUserNoticeInPacket...", this.toString());
	}
	...
	public String toString() {
		return "GetNgroupKickUserNoticeInPacket [ngroup_id=" + ngroup_id
