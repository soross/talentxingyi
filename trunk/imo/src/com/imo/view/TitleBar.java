...
//			tv_name.setTextSize((float) (getResources().getDimension(R.dimen.titlebar_name_fontsize) * IMOApp.getApp().mScale)) ;
//			tv_worksign.setTextSize((float) (getResources().getDimension(R.dimen.titlebar_worksign_fontsize) * IMOApp.getApp().mScale)) ;
//		}
...
//			if ( leftBtnString.equals(getResources().getString(R.string.back))) {
//				btn_left.setBackgroundResource(R.drawable.titlebar_btn_back_bg);
//			}else{
//				btn_left.setBackgroundResource(R.drawable.titlebar_btn_bg);
//			}
...
//	 */
//	public void initDefaultTitleBar(int leftBtnResId,String centerString,int rightBtnResId) {
//		
//		this.setVisibility(View.VISIBLE);
//		
//		showView(mView_DefaultType);
...
//			ViewGroup.LayoutParams params1 = (ViewGroup.LayoutParams) face_frame.getLayoutParams();
...
//			
//			RelativeLayout.LayoutParams params2 = (RelativeLayout.LayoutParams)mView_SpecialType.getLayoutParams();
