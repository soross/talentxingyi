...
public class RecentContactInfo {
	 ...
	 * @param count
	 */
	public RecentContactInfo(Integer cid, Integer uid, String name, String info, String time, int count) {
		this.cid = cid;
		this.uid = uid;
		this.name = name;
		this.info = info;
	...
	public RecentContactInfo(Integer cid, Integer uid, String name, String info, String time, int count, int type) {
		this.cid = cid;
		this.uid = uid;
		this.name = name;
		this.info = info;
	...
	public RecentContactInfo(String name, String info, String time, int count) {
		this.name = name;
		this.info = info;
		this.time = time;
		this.count = count;
