...
public class SystemSetActivity extends AbsBaseActivityNetListener implements OnSettingItemClickListener, IAppUpdate {
	...
	private int[] item_ids = {
			R.id.notice_setting, R.id.sound_prompt, R.id.vibrate_prompt, R.id.state_setting, R.id.new_features, R.id.app_update, R.id.about_app
	};
	...
	protected void installViews() {
		...
		mTitleBar.initDefaultTitleBar(resources.getString(R.string.back), resources.getString(R.string.system_setting));
		...
		switch (v.getId()) {
			case R.id.notice_setting: {
				...
				PreferenceManager.save(Globe.SP_FILE, new Object[] {
						IS_NOTIFICATION, Globe.is_notification
				});
