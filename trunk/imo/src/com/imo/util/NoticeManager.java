...
//		}
	 ...
	 * @param isBoy
	 */
	public static void updateNewsNotice(NotificationManager notificationManager,Notification notice,String msgTitle,CharSequence content,
			int cid,int uid,String fromUserName){
...
//		String className = "com.imo.module.dialogue.DialogueActivity";
		intent.putExtra("from_notice", true);////if from notice,need reset count.
