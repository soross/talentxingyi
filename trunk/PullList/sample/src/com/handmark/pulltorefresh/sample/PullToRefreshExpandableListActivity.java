...
public class PullToRefreshExpandableListActivity extends ExpandableListActivity {
	...
	private final String[] mChildStrings = { "Child One", "Child Two",
			"Child Three", "Child Four", "Child Five", "Child Six" };

	private final String[] mGroupStrings = { "Group One", "Group Two",
			"Group Three" };
}
