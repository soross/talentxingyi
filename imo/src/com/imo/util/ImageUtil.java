...
public class ImageUtil {
	...
	public static Bitmap generateRoundCornerBitmap(Bitmap bitmap, float roundPx, int boardColor) {
		...
		// final Rect rect = new Rect(2, 2, bitmap.getWidth()-2,
		// bitmap.getHeight()-2);
	...
	private LayerDrawable getLayerDrawable(Context mContext) {
		...
		int top = (int) (mContext.getResources().getDimension(R.dimen.titlebar_face_height) * IMOApp.getApp().mScale);
		Drawable[] faceFrameArray = new Drawable[2];
		faceFrameArray[0] = mContext.getResources().getDrawable(R.drawable.imo_titlebar_gradual_bg);
		// faceFrameArray[1] =
