...
public class StateSetActivity extends AbsBaseActivityNetListener implements OnSettingItemClickListener {
	...
	protected void installViews() {
		...
		mTitleBar.initDefaultTitleBar(resources.getString(R.string.back), resources.getString(R.string.state_setting));
	...
	public void onSettingItemClick(View v) {
		...
		switch (v.getId()) {
			...
			case R.id.background_keep_online_scope:
				new TimePickerDialog(mContext, mTimeSetListener, 00, 00, true).show();
				break;
