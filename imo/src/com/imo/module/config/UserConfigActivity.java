...
public class UserConfigActivity extends AbsBaseActivityNetListener implements 	OnSettingItemClickListener {
	...
	private View iv_edit_worksign,worksign_view,layout_edit_worksign;
	...
	protected void installViews() {
		...
		iv_edit_worksign =  findViewById(R.id.iv_edit_worksign);
		worksign_view =  findViewById(R.id.worksign_view);
		...
		mTitleBar.initDefaultTitleBar(resources.getString(R.string.back),
				resources.getString(R.string.my_profil_setting));
...
//		iv_userFace.setBackgroundResource(R.drawable.imo_face_board_empty);
		 
//		if (networkIsConnected) {
//			
//			if (Globe.bm_head != null) {
//				LogFactory.d(TAG, "bm_head not null");
//				iv_userFace.setImageBitmap(ImageUtil.generateRoundCornerBitmap(Globe.bm_head, mGlobal.radius,face_width,face_width,borderColor));
//			}else{
//				boolean isBoy = isBoy(Globe.myself==null?1:Globe.myself.getGender());
//				if (isBoy) {
//					iv_userFace.setImageResource(R.drawable.imo_default_face_boy);
//				}else{
//					iv_userFace.setImageResource(R.drawable.imo_default_face_girl);
//				}
//			}
//			
//		}else {
//			if (Globe.bm_head != null) {
//				ImageUtil.setFaceImg(iv_userFace, Globe.bm_head, 0,borderColor);
//			}else{
//				iv_userFace.setImageResource(R.drawable.imo_default_face);
//			}
//		}
	}
