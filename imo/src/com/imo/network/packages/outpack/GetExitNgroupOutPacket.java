...
public class GetExitNgroupOutPacket extends CommonOutPacket{

	public GetExitNgroupOutPacket(ByteBuffer aBody, short aCommand, int aCid,
			int aUid) {
		super(aBody, aCommand, aCid, aUid);
		// TODO Auto-generated constructor stub
	}
	
	public static ByteBuffer GenerateNgroupChatBody(int transid , int ngroup_id) {
