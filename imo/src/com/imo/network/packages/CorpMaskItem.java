...
public class CorpMaskItem {
	...
	public CorpMaskItem(String corp_account, String short_name, String cn_name, String domain, int state, int user_card, int logo_type, String en_name, String nation, String province, String city, String country, String addr, int type, String desp, int zipcode, String tel, String fax,
			String contactor, String email, String website, int reg_capital, int employee_num, int pc_num, String slogan, String config) {
		super();
	...
	public CorpMaskItem(int aMask, ByteBuffer aBody) {
		...
		LogFactory.d(CorpMaskItem.class.getSimpleName(), "mask = " + resultStr);
