...
public class DialogueInfo {
	...
	public DialogueInfo(int unNgroup_id, int unSubRet, int unNgroup_sessionid, String sNgroup_name, String sNgroup_announcement, int unHost_cid, int unHost_uid) {
		super();
	...
	public String toString() {
		return "DialogueInfo [unNgroup_id=" + unNgroup_id + ", unSubRet=" + unSubRet + ", unNgroup_sessionid=" + unNgroup_sessionid + ", sNgroup_name=" + sNgroup_name + ", sNgroup_announcement=" + sNgroup_announcement + ", unHost_cid=" + unHost_cid + ", unHost_uid=" + unHost_uid + "]";
	}
