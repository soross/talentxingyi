...
public final class PullToRefreshGridActivity extends Activity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, MENU_SET_MODE, 0, mPullRefreshGridView.getMode() == Mode.BOTH ? "Change to MODE_PULL_DOWN" : "Change to MODE_PULL_BOTH");
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		setModeItem.setTitle(mPullRefreshGridView.getMode() == Mode.BOTH ? "Change to MODE_PULL_FROM_START" : "Change to MODE_PULL_BOTH");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case MENU_SET_MODE:
			mPullRefreshGridView.setMode(mPullRefreshGridView.getMode() == Mode.BOTH ? Mode.PULL_FROM_START : Mode.BOTH);
			break;
		}
