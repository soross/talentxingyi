...
public class GridAdapter extends BaseAdapter {
     ...
     * 9宫格图片
     */
    private static final int[] mGridResources = new int[]{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = (LinearLayout) LayoutInflater.from(mContext).inflate(R.layout.item_home_grid, null);
        }
        ImageView ivGrid = (ImageView) convertView.findViewById(R.id.imageViewGrid);
        TextView tvGrid = (TextView) convertView.findViewById(R.id.textViewGrid);
